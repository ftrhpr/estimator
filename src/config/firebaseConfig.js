...
// 4. Go to General tab and scroll down to "Your apps"
...
if (!isFirebaseConfigured) {
  console.warn('⚠️ Firebase is not configured properly. Please set up your .env file with Firebase credentials.');
}
